...
**DiGi.Communication** is a C# engineering and architectural software library suite designed for BIM and CAD integrations (such as Revit, RhinoCommon, Grasshopper, and Dynamo BIM).
...
* **[DiGi.Communication.ComputeSharp](DiGi.Communication.ComputeSharp)** (Path: `DiGi.Communication\DiGi.Communication.ComputeSharp`)
* **[DiGi.Communication](DiGi.Communication)** (Path: `DiGi.Communication\DiGi.Communication`)
